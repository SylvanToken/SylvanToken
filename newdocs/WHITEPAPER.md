...
| `configureAdminWallet` | Owner | Setup admin vesting |
| `processInitialRelease` | Owner | Release initial 10% |
| `processMonthlyRelease` | Owner | Monthly vesting release |
| `processLockedWalletRelease` | Owner | Locked wallet release |
| `addExemptWallet` | Owner | Add fee exemption |
