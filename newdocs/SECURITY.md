...
|----------|--------------|
| `transfer` | Public |
| `configureAdminWallet` | Owner Only |
| `processInitialRelease` | Owner Only |
| `processMonthlyRelease` | Owner Only |
| `addExemptWallet` | Owner Only |
...
└─ 0x1109B6aDB60dB170139f00bA2490fCA0F8BE7A8C (Admin)
```
